...
Варіант 11<br>
Реалізувати клас, що представляє систему двох рівнянь з двома невідомими. 
Передбачити індексатор для доступу до коефіцієнтів першого та другого рівняння(індексатор з двома індексами: перший – номер рівняння, другий – номер коефіцієнта).
Передбачити також методи введення/виведення, знаходження розв’язку, перевірки точки на те, чи є вона розв’язком системи рівнянь.
Варіант 7<br>
Клас “коло” – TCircle
- Поля 
